const STORAGE_KEY = "ycylq-map-prototype-v5";
...
const goalTemplates = [
  ...
  },
  {
    ...
    requirements: { acting: 54, charm: 62, capital: 75 },
  ...
  return `
    <header class="topbar">
      ...
      <div class="top-stats">
        ...
        <button class="phone-icon-btn" data-open-phone title="打开经纪人手机" aria-label="打开经纪人手机"><span></span></button>
