const STORAGE_KEY = "ycylq-map-prototype-v12";
const DEMO_VERSION = "v2.6-dev-20260603";
...
const monthlyRoutePlans = [
  {
    id: "acting-month",
    path: "acting",
    name: "影视演艺月",
    cost: 12,
    desc: "安排围读、试镜课和剧组社交，适合把演技兑现成作品机会。",
    weeklyDelta: { acting: 4, charm: 1, reputation: 2, stress: 3, trust: 1, sensibility: 1 },
    weeklyIncome: 3
  },
  {
    id: "music-month",
    ...
    name: "音乐唱作月",
    cost: 12,
    desc: "录小样、见制作人、打磨作品，成长慢但能沉淀长期口碑。",
    weeklyDelta: { vocal: 4, creativity: 3, reputation: 2, stress: 2, sensibility: 2 },
    weeklyIncome: 2
  },
  {
    id: "variety-month",
    ...
    name: "综艺舞台月",
    cost: 10,
    desc: "综艺试录、热梗营业和舞台曝光并行，热度涨得快，压力也涨得快。",
    weeklyDelta: { stage: 3, charm: 3, heat: 5, fans: 2, reputation: -1, stress: 5, ambition: 2 },
    weeklyIncome: 5
  },
  {
    id: "commercial-month",
    ...
    name: "商业营业月",
    cost: 8,
    desc: "优先接商务、直播和品牌短约，公司现金流舒服，但专业成长较慢。",
    weeklyDelta: { charm: 2, heat: 4, fans: 3, reputation: -2, stress: 4, trust: -1, discipline: -1 },
    weeklyIncome: 9
  }
];
...
const longTermPositions = [
  {
    id: "acting",
    name: "影视突破",
    desc: "优先积累剧组履历、表演口碑和角色机会。",
    delta: { acting: 3, reputation: 2, heat: 1, stress: 2, discipline: 1 }
  },
  {
    id: "music",
    name: "音乐唱作",
    desc: "优先打磨唱功、创作和作品记忆点。",
    delta: { vocal: 3, creativity: 3, reputation: 1, stress: 1, sensibility: 1 }
  },
  {
    id: "variety",
    name: "综艺曝光",
    desc: "优先获得镜头、热梗和粉丝增长。",
    delta: { stage: 2, charm: 3, heat: 3, fans: 2, stress: 3, ambition: 1 }
  },
  {
    id: "commercial",
    name: "商业变现",
    desc: "优先商务、直播和品牌转化，让公司回血。",
    delta: { charm: 2, heat: 2, fans: 2, reputation: -1, stress: 3, trust: -1 }
  },
  {
    id: "balanced",
    name: "全能试水",
    desc: "暂不押单一路线，均衡试探市场反馈。",
    delta: { vocal: 1, acting: 1, stage: 1, charm: 1, creativity: 1, trust: 1 }
  },
  {
    id: "observe",
    name: "放养观察",
    desc: "少投入、低打扰，等待市场自己给信号。",
    delta: { stress: -2, trust: 1, reputation: 1 }
  }
];
...
const companyStrategies = [
  {
    ...
    name: "冲热度",
    cost: 8,
    desc: "全公司优先曝光和话题，数据涨得快，口碑和压力更危险。",
    weeklyDelta: { heat: 5, fans: 2, reputation: -2, stress: 4, ambition: 1 },
    weeklyIncome: 4,
    decisionPath: "variety"
  },
  {
    id: "reputation",
    name: "稳口碑",
    cost: 6,
    desc: "减少低质曝光，优先作品、口碑和长期形象。",
    weeklyDelta: { reputation: 4, heat: 1, stress: -1, trust: 1, discipline: 1 },
    weeklyIncome: 1,
    decisionPath: "acting"
  },
  {
    ...
    name: "赚钱回血",
    cost: 2,
    desc: "优先商务和营业，公司现金流舒服，艺人会更像赚钱机器。",
    weeklyDelta: { heat: 2, fans: 2, reputation: -2, stress: 5, trust: -2 },
    weeklyIncome: 10,
    decisionPath: "commercial"
  },
  {
    id: "cultivate",
    name: "培养新人",
    cost: 10,
    desc: "把预算砸进训练和基础团队，短期不爆，但底子会变厚。",
    weeklyDelta: { vocal: 1, acting: 1, stage: 1, charm: 1, creativity: 1, stress: 2, trust: 2 },
    weeklyIncome: 0,
    decisionPath: "music"
  },
  {
    ...
    name: "押宝影视",
    cost: 12,
    desc: "集中公司资源打影视机会，适合演技型和资源咖。",
    weeklyDelta: { acting: 4, reputation: 2, heat: 2, stress: 3 },
    weeklyIncome: 3,
    decisionPath: "acting"
  },
  {
    ...
    name: "押宝音乐",
    cost: 12,
    desc: "集中资源做小样、制作人会面和作品发行。",
    weeklyDelta: { vocal: 3, creativity: 4, reputation: 2, stress: 2, sensibility: 1 },
    weeklyIncome: 2,
    decisionPath: "music"
  },
  {
    ...
    name: "控压休整",
    cost: 4,
    desc: "减少压榨和曝光，修复艺人关系与状态。",
    weeklyDelta: { stress: -7, trust: 4, reputation: 1, heat: -1 },
    weeklyIncome: 0,
    decisionPath: "commercial"
  }
];

const majorDecisionTemplates = {
  acting: {
    title: "剧组递来两份选择",
    desc: "一个平台短剧给主角位，快但粗糙；一个院线项目只有小配角，慢但履历更硬。",
    choices: [
      { id: "fast-lead", label: "接短剧主角", desc: "立刻有脸，口碑看命。", delta: { heat: 12, fans: 5, acting: 2, reputation: -4, stress: 6, ambition: 4 }, moneyDelta: 6, result: "短剧宣发很猛，艺人终于有了姓名。只是评论区开始争论这到底算不算作品。" },
      { id: "slow-support", label: "蹲院线配角", desc: "曝光少，但履历更稳。", delta: { acting: 6, reputation: 7, heat: 3, stress: 3, trust: 3, discipline: 2 }, moneyDelta: 1, result: "配角戏份不多，但导演记住了 TA。慢钱难赚，硬履历开始长出来。" }
    ]
  },
  music: {
    title: "制作人给出残酷建议",
    desc: "要么改成更好卖的口水歌，要么坚持原创表达继续慢慢磨。",
    choices: [
      { id: "market-song", label: "改口水歌", desc: "播放快，艺术心会受点伤。", delta: { vocal: 2, creativity: -2, heat: 10, fans: 5, reputation: -2, stress: 4 }, moneyDelta: 5, result: "副歌开始洗脑，数据终于动了。艺人说没事，眼神像刚删掉一整页真心话。" },
      { id: "author-song", label: "坚持原创", desc: "慢，但作品会留下。", delta: { creativity: 7, vocal: 4, reputation: 6, heat: 2, trust: 3, sensibility: 4 }, moneyDelta: 0, result: "歌没爆，但听过的人开始复听。娱乐圈很吵，作品先替 TA 小声站住了。" }
    ]
  },
  variety: {
    title: "综艺剪辑台伸出橄榄枝",
    desc: "节目组想把艺人剪成话题担当，能爆，但可能被骂。",
    choices: [
      { id: "accept-script", label: "接受人设剧本", desc: "黑红也是红。", delta: { heat: 16, fans: 6, reputation: -8, stress: 8, ambition: 4, trust: -2 }, moneyDelta: 8, result: "节目播出后热搜冲得很高。粉丝说有梗，路人说吵，商务说能报价。" },
      { id: "keep-boundary", label: "拒绝恶剪人设", desc: "少一点热度，多一点底线。", delta: { reputation: 5, trust: 5, heat: 4, fans: 2, stress: -2, discipline: 3 }, moneyDelta: 2, result: "镜头少了，但艺人松了一口气。不是每一次曝光都值得拿人格去换。" }
    ]
  },
  commercial: {
    title: "品牌方想要更激进的营业",
    desc: "高报价要求强绑定 CP 和连续直播，短期现金流很好，粉圈可能爆炸。",
    choices: [
      { id: "cash-in", label: "接高压营业", desc: "钱到位，压力也到位。", delta: { heat: 10, fans: 4, reputation: -5, stress: 10, romance: 3, trust: -3 }, moneyDelta: 14, result: "品牌方很满意，财务也很满意。艺人下播后只发来一句：我先不看手机了。" },
      { id: "selective-brand", label: "筛选温和合作", desc: "少赚一点，长期更稳。", delta: { reputation: 4, charm: 3, fans: 2, stress: 2, trust: 3, discipline: 2 }, moneyDelta: 5, result: "商务少赚了几万，但粉圈没有炸。经纪人第一次觉得平安也是一种利润。" }
    ]
  }
};
...
const candidateArtists = [
  {
    ...
    route: "舞台潜力突出，但也可以转向音乐、影视或商业路线，取决于玩家设定的长期定位和公司策略。",
  ...
  },
  {
    ...
    route: "创作潜力高，但可以通过长期定位和公司策略转向唱作、影视配乐、综艺或商业合作。",
...
function createInitialState() {
  return {
    ...
    pendingEvent: null,
    pendingPlan: null,
    pendingCompanyStrategy: null,
    pendingMajorDecision: null,
...
function normalizeState(nextState) {
  nextState.signedArtists = Array.isArray(nextState.signedArtists) ? nextState.signedArtists : [];
  if (!nextState.signedArtists.length && nextState.artist) {
    nextState.signedArtists = [nextState.artist];
  }
  nextState.signedArtists = nextState.signedArtists.map(normalizeSignedArtist);
  if (!nextState.activeArtistId && nextState.artist?.id) {
    nextState.activeArtistId = nextState.artist.id;
  }
  if (!nextState.activeArtistId && nextState.signedArtists.length) {
    nextState.activeArtistId = nextState.signedArtists[0].id;
  }
  const activeArtist = nextState.signedArtists.find((artist) => artist.id === nextState.activeArtistId) || null;
  nextState.artist = activeArtist;
  if (nextState.artist) {
  ...
  nextState.pendingPlan ||= null;
  nextState.pendingCompanyStrategy ||= null;
  nextState.pendingMajorDecision ||= null;
  nextState.companyStrategy ||= null;
  nextState.monthSummary ||= null;
  ...
  nextState.showArtistManager = Boolean(nextState.showArtistManager);
  nextState.showStrategyPicker = Boolean(nextState.showStrategyPicker);
  ...
  if (nextState.actionNotice?.text) {
    ...
    nextState.actionNotice.label ||= "项目反馈";
    nextState.actionNotice.location ||= nextState.actionNotice.place || "经纪公司";
    nextState.actionNotice.speaker ||= nextState.actionNotice.person || "现场负责人";
  }
  return nextState;
}

function normalizeSignedArtist(artist) {
  const template = candidateArtists.find((item) => item.id === artist.id);
  const normalized = {
    ...clone(template || artist),
    ...artist
  };
  normalized.attrs = normalizeProfessionalAttrs(normalized.attrs || template?.attrs || {});
  normalized.market ||= clone(template?.market || { heat: 0, fans: 0, reputation: 40 });
  normalized.mind ||= clone(template?.mind || { stress: 20, trust: 45 });
  normalized.profile ||= clone(template?.profile || { age: 22, background: "未知背景", fandom: "粉丝结构未知", capital: 20, marketPosition: "待定位艺人", signCost: 10, difficulty: "需要重新评估发展难度。", growthHint: "先用地图项目验证最适合的市场路径。" });
  normalized.personality ||= clone(template?.personality || { sensibility: 50, ambition: 50, romance: 40, discipline: 50 });
  normalized.monthPlan ||= null;
  normalized.longTermPath ||= inferInitialLongTermPath(normalized);
  normalized.planHistory ||= [];
  return normalized;
}

function inferInitialLongTermPath(artist) {
  const idMap = {
    "jiang-che": "acting",
    "wen-ran": "music",
    "qiao-yiyi": "variety",
    "luo-yinhe": "commercial",
    "yan-ruoxi": "acting",
    "lin-xiaotang": "variety"
  };
  return idMap[artist.id] || "balanced";
}

function syncActiveArtist() {
  state.artist = state.signedArtists.find((artist) => artist.id === state.activeArtistId) || state.signedArtists[0] || null;
  state.activeArtistId = state.artist?.id || null;
}
...
function getIncomingMoney() {
  return getCompanyBaseIncome() + getMonthlyPlanIncome() + (state.weeklyIncomeBoost || 0);
}

function getFinanceBreakdown() {
  if (!state.signedArtists.length) {
    return {
  ...
  const baseIncome = getCompanyBaseIncome();
  const planIncome = getMonthlyPlanIncome();
  const boost = planIncome + (state.weeklyIncomeBoost || 0);
  const operatingCost = getCompanyOperatingCost();
  const incoming = baseIncome + boost;
  const incomeLines = state.signedArtists
    .map((artist) => {
      const position = getLongTermPosition(artist.longTermPath);
      return `${artist.name}：基础回款 ${getWeeklyBaseIncome(artist)} 万；长期定位「${position.name}」`;
    })
    .join(" / ");
  return {
    current: state.money,
...
function buildArtistMessage(kind, detail = {}) {
  ...
  if (kind === "position") {
    return `“${mood.line} 长期定位改成「${context}」我收到了。以后我会自己往这个方向跑，但关键时候你别只看公司报表。”`;
  }

  if (kind === "strategy") {
    return `“公司这个月要走「${context}」是吧。${mood.line} 我会配合，只是如果我撑不住了，希望你能看见。”`;
  }
...
function selectArtist(id) {
  ...
  if (!selected) return;
  state.selectedId = id;
  const existing = state.signedArtists.find((artist) => artist.id === id);
  if (existing) {
    state.activeArtistId = id;
    syncActiveArtist();
    state.floatingNotice = `已切换到 ${existing.name}。`;
    saveState();
    render();
    return;
  }
  const signCost = getSignCost(selected);
  if (state.money < signCost) {
    state.actionNotice = {
      title: "签约失败",
      label: "签约反馈",
      location: "艺人经纪部",
      speaker: "财务",
      text: `账上只剩 ${state.money} 万，签下 ${selected.name} 需要 ${signCost} 万。娱乐圈可以画饼，合同首款不能。`,
      tone: "bad",
      energy: "不消耗",
  ...
  const firstArtist = state.signedArtists.length === 0;
  const signed = normalizeSignedArtist(clone(selected));
  state.signedArtists.push(signed);
  state.activeArtistId = signed.id;
  syncActiveArtist();
  if (firstArtist) {
    state.week = 1;
    state.weeklyIncomeBoost = 0;
    ...
    state.pendingMajorDecision = null;
    state.gameOver = null;
  ...
  state.money = Math.max(0, state.money - signCost);
  ...
  state.showArtistManager = true;
  state.eventText = `签约 ${selected.name}，签约费 ${signCost} 万。公司剩余资金 ${state.money} 万。接下来为 TA 规划未来一个月的发展路线。`;
  state.logs.unshift({
    week: state.week,
    text: `${selected.name} 加入工作室。签约费 ${signCost} 万。${selected.route}`
  });
...
function getMonthlyPlan(planId) {
  return monthlyRoutePlans.find((plan) => plan.id === planId) || monthlyRoutePlans[0];
}

function getLongTermPosition(path) {
  return longTermPositions.find((position) => position.id === path) || longTermPositions.find((position) => position.id === "balanced");
}

function getCompanyStrategy(strategyId) {
  return companyStrategies.find((strategy) => strategy.id === strategyId) || companyStrategies[0];
}

function setLongTermPosition(artistId, path) {
  const artist = state.signedArtists.find((item) => item.id === artistId);
  const position = getLongTermPosition(path);
  if (!artist || !position) return;
  artist.longTermPath = position.id;
  state.activeArtistId = artist.id;
  syncActiveArtist();
  state.floatingNotice = `${artist.name} 的长期定位调整为「${position.name}」。`;
  addArtistPhoneMessage("position", { context: position.name, path: position.id });
  saveState();
  render();
}

function openCompanyStrategyConfirm(strategyId) {
  const strategy = getCompanyStrategy(strategyId);
  if (!strategy || state.gameOver) return;
  state.pendingCompanyStrategy = strategy.id;
  state.showStrategyPicker = false;
  saveState();
  render();
}

function confirmCompanyStrategy() {
  if (!state.pendingCompanyStrategy || state.gameOver) return;
  const strategy = getCompanyStrategy(state.pendingCompanyStrategy);
  if (!strategy || state.money < strategy.cost) return;
  state.money -= strategy.cost;
  ...
  state.pendingCompanyStrategy = null;
  state.monthSummary = null;
  state.eventText = `公司本月策略确定为「${strategy.name}」，预算支出 ${strategy.cost} 万。艺人日常自动执行，只有重大机会和异常会打断你。`;
  state.logs.unshift({ week: state.week, text: state.eventText });
  state.logs = state.logs.slice(0, 10);
  const originalActiveId = state.activeArtistId;
  state.signedArtists.slice(0, 2).forEach((artist) => {
    state.activeArtistId = artist.id;
    syncActiveArtist();
    addArtistPhoneMessage("strategy", { context: strategy.name });
  });
  state.activeArtistId = originalActiveId;
  syncActiveArtist();
  if (state.money <= BANKRUPT_LINE) {
    state.money = 0;
    state.gameOver = {
      type: "bankrupt",
      title: "公司破产",
      text: "公司策略刚开会通过，财务先举手投降。",
      detail: `策略预算 ${strategy.cost} 万，资金归零。`
    };
  }
  saveState();
  render();
...
function cancelCompanyStrategy() {
  state.pendingCompanyStrategy = null;
  saveState();
  render();
}
...
function openPlanConfirm(artistId, planId) {
  const artist = state.signedArtists.find((item) => item.id === artistId);
  const plan = getMonthlyPlan(planId);
  if (!artist || !plan || state.gameOver) return;
  state.pendingPlan = { artistId, planId };
  saveState();
  render();
}

function confirmMonthlyPlan() {
  if (!state.pendingPlan || state.gameOver) return;
  const artist = state.signedArtists.find((item) => item.id === state.pendingPlan.artistId);
  const plan = getMonthlyPlan(state.pendingPlan.planId);
  if (!artist || !plan || state.money < plan.cost) return;
  ...
  artist.planHistory = artist.planHistory || [];
  artist.planHistory.unshift({ week: state.week, name: plan.name, cost: plan.cost });
  state.pendingPlan = null;
  state.activeArtistId = artist.id;
  syncActiveArtist();
  state.eventText = `${artist.name} 开始未来一个月的「${plan.name}」，公司先支付 ${plan.cost} 万预算。接下来 TA 会自动成长和回款，重大选择由你拍板。`;
  state.logs.unshift({ week: state.week, text: state.eventText });
  state.logs = state.logs.slice(0, 10);
  addArtistPhoneMessage("goal", { path: plan.path, context: plan.name });
  if (state.money <= BANKRUPT_LINE) {
    state.money = 0;
    state.gameOver = {
      type: "bankrupt",
      title: "公司破产",
      text: `${artist.name} 的月度规划刚启动，公司账面就见底了。理想很饱满，现金流很法务。`,
      detail: `规划支出 ${plan.cost} 万，资金归零。`
    };
  }
  saveState();
  render();
...
function setActiveArtist(artistId) {
  if (!state.signedArtists.some((artist) => artist.id === artistId)) return;
  state.activeArtistId = artistId;
  syncActiveArtist();
  state.phoneFeed = generatePhoneFeed(state.artist, state.week);
  state.floatingNotice = `当前查看 ${state.artist.name}。`;
  saveState();
  render();
}

function getCompanyBaseIncome() {
  return state.signedArtists.reduce((sum, artist) => sum + getWeeklyBaseIncome(artist), 0);
}

function getCompanyOperatingCost() {
  return state.signedArtists.reduce((sum, artist) => sum + getWeeklyOperatingCost(artist), 0);
}

function getMonthlyPlanIncome() {
  if (!state.companyStrategy) return 0;
  return (getCompanyStrategy(state.companyStrategy.id).weeklyIncome || 0) * Math.max(1, state.signedArtists.length);
}

function processArtistAutoGrowth() {
  let planIncome = 0;
  const reports = [];
  const strategy = state.companyStrategy ? getCompanyStrategy(state.companyStrategy.id) : null;
  state.signedArtists.forEach((artist) => {
    artist.mind.stress = clamp((artist.mind.stress || 0) - 3);
    const position = getLongTermPosition(artist.longTermPath);
    applyDelta(artist, position.delta || {});
    if (strategy) {
      applyDelta(artist, strategy.weeklyDelta || {});
      const synergy = strategy.decisionPath === position.id;
      if (synergy) {
        applyDelta(artist, { heat: 1, fans: 1, trust: 1 });
      }
      planIncome += strategy.weeklyIncome || 0;
      reports.push(`${artist.name} 按「${position.name}」自行推进，叠加公司策略「${strategy.name}」${synergy ? "，方向高度匹配" : ""}。`);
    } else {
      applyDelta(artist, { reputation: 1, trust: 1 });
      reports.push(`${artist.name} 按长期定位「${position.name}」自由行动；公司本月暂无策略，成长较慢。`);
    }
  });
  if (state.companyStrategy) {
    state.companyStrategy.weeksLeft -= 1;
    state.companyStrategy.reports = [...(state.companyStrategy.reports || []), ...reports].slice(-12);
    if (state.companyStrategy.weeksLeft <= 0) {
      const strategy = getCompanyStrategy(state.companyStrategy.id);
      state.monthSummary = buildMonthSummary(strategy, reports);
      state.companyStrategy = null;
    }
  }
  const baseIncome = getCompanyBaseIncome();
  const cost = getCompanyOperatingCost();
  const net = baseIncome + planIncome - cost;
  state.money += net;
  if (state.monthSummary) {
    state.monthSummary.money = state.money;
  }
  if (state.money <= BANKRUPT_LINE) {
    state.money = 0;
    state.gameOver = {
      type: "bankrupt",
      title: "公司破产",
      text: "艺人们还在按计划成长，公司现金流先倒在了现实里。",
      detail: `本周基础回款 ${baseIncome} 万，策略回款 ${planIncome} 万，运营成本 ${cost} 万。`
    };
  }
  return { baseIncome, planIncome, cost, net, reports };
}

function buildMonthSummary(strategy, reports) {
  const topArtist = [...state.signedArtists].sort((a, b) => getCafeScore(b) - getCafeScore(a))[0];
  return {
    title: `${strategy.name} 月度总结`,
    strategy: strategy.name,
    text: `本月公司选择「${strategy.name}」。${topArtist ? `${topArtist.name} 目前声量最高，市场定位是 ${topArtist.profile.marketPosition}。` : ""}`,
    money: state.money,
    reports: reports.slice(-4)
  };
}

function maybeCreateMajorDecision() {
  if (state.pendingMajorDecision || state.pendingEvent || state.gameOver) return null;
  if (!state.companyStrategy || state.companyStrategy.decisionUsed || state.companyStrategy.weeksLeft > 3) return null;
  const strategy = getCompanyStrategy(state.companyStrategy.id);
  const artist =
    state.signedArtists.find((item) => item.longTermPath === strategy.decisionPath) ||
    state.signedArtists.find((item) => item.longTermPath !== "observe") ||
    state.signedArtists[0];
  if (!artist) return null;
  const decisionPath = strategy.decisionPath || artist.longTermPath || "commercial";
  const template = majorDecisionTemplates[decisionPath];
  if (!template) return null;
  state.companyStrategy.decisionUsed = true;
  state.pendingMajorDecision = {
    artistId: artist.id,
    path: decisionPath,
  ...
  state.activeArtistId = artist.id;
  syncActiveArtist();
  return state.pendingMajorDecision;
}

function resolveMajorDecision(choiceId) {
  if (!state.pendingMajorDecision || state.gameOver) return;
  const decision = state.pendingMajorDecision;
  const artist = state.signedArtists.find((item) => item.id === decision.artistId);
  const choice = decision.choices.find((item) => item.id === choiceId);
  if (!artist || !choice) return;
  applyDelta(artist, choice.delta || {});
  ...
  state.activeArtistId = artist.id;
  syncActiveArtist();
  state.eventText = `${artist.name} 重大决策：${choice.label}。${choice.result}${choice.moneyDelta ? ` 公司资金 ${choice.moneyDelta > 0 ? "+" : ""}${choice.moneyDelta} 万。` : ""}`;
  state.actionNotice = {
    title: choice.label,
    label: "重大决策",
    location: "公司策略",
    ...
    tone: choice.moneyDelta < 0 || (choice.delta?.reputation || 0) < -3 ? "event" : "good",
    energy: "自动经营",
    money: formatMoney(state.money)
  };
  state.logs.unshift({ week: state.week, text: state.eventText });
  state.logs = state.logs.slice(0, 10);
  addArtistPhoneMessage("event", { context: choice.label });
  if (state.money <= BANKRUPT_LINE) {
    state.money = 0;
    state.gameOver = {
      type: "bankrupt",
      title: "公司破产",
      text: "重大决策刚落地，公司现金流被现实补了一刀。",
      detail: state.eventText
    };
  }
  saveState();
  render();
...
function runProject(projectId) {
  ...
  if (!project || state.showGoalModal || state.pendingEvent || state.pendingMajorDecision || state.energy < project.cost) return;
...
function advanceWeek() {
  if (!state.artist || state.pendingEvent || state.pendingMajorDecision || state.gameOver) return;
  ...
  const finance = processArtistAutoGrowth();
  syncActiveArtist();
  const financeText = `本周艺人基础回款 ${finance.baseIncome} 万，策略回款 ${finance.planIncome} 万，运营成本 ${finance.cost} 万，净变化 ${finance.net >= 0 ? "+" : ""}${finance.net} 万，公司资金 ${state.money} 万。`;
  const majorDecision = maybeCreateMajorDecision();
  state.pendingEvent = state.gameOver || state.monthSummary || majorDecision ? null : pickWeeklyEvent();
  state.eventText = state.gameOver
    ? `${goalResult ? `${goalResult} ` : ""}进入第 ${state.week} 周。${financeText} 公司破产，游戏结束。`
    : state.monthSummary
      ? `${goalResult ? `${goalResult} ` : ""}进入第 ${state.week} 周。${financeText} ${finance.reports.join(" ")} 本月公司策略结算，查看月末总结。`
    : majorDecision
      ? `${goalResult ? `${goalResult} ` : ""}进入第 ${state.week} 周。${financeText} ${finance.reports.join(" ")} 重大决策出现：${majorDecision.title}。`
      : state.pendingEvent
        ? `${goalResult ? `${goalResult} ` : ""}进入第 ${state.week} 周。${financeText} ${finance.reports.join(" ")} 本周突发事件需要先处理：${state.pendingEvent.title}。`
        : `${goalResult ? `${goalResult} ` : ""}进入第 ${state.week} 周。${financeText} ${finance.reports.join(" ")}`;
  state.logs.unshift({
    week: state.week,
    text: state.eventText
  });
...
function render() {
  ...
  if (!state.artist) {
    app.innerHTML = `
      <main class="app">
        ...
        ${state.showArtistManager ? renderArtistManagerModal() : ""}
        ${state.showCalendar ? renderCalendarModal() : ""}
        ${state.showFinance ? renderFinanceModal() : ""}
        ${state.showStrategyPicker ? renderStrategyPickerModal() : ""}
        ${state.pendingCompanyStrategy ? renderCompanyStrategyConfirmModal() : ""}
        ${state.monthSummary ? renderMonthSummaryModal() : ""}
        ${state.pendingPlan ? renderPlanConfirmModal() : ""}
  ...
  app.innerHTML = `
    <main class="app">
      ...
      ${state.pendingMajorDecision ? renderMajorDecisionModal() : ""}
      ${state.showCalendar ? renderCalendarModal() : ""}
  ...
  return `
    <section class="select-screen">
      <div class="select-intro">
        ...
        <h2>选择初始艺人</h2>
        <p>公司初始资金 ${INITIAL_MONEY} 万。可以签约多名艺人，签约后进入“艺人”界面设定长期定位，再用公司本月策略驱动自动经营。</p>
      </div>
  ...
  return `
    <header class="topbar">
      <div class="top-stats">
        ...
        <button class="ghost-btn" data-reset onclick="localStorage.removeItem('ycylq-map-prototype-v12'); location.reload()" title="重置原型进度">重置</button>
      </div>
      ${renderFinanceButton()}
    </header>
  `;
...
function renderQuickTools() {
  ...
  return `
    <nav class="quick-tools" aria-label="经纪人工具">
      <button class="quick-tool artist-tool" data-open-artists title="艺人" aria-label="打开艺人管理">
        <span>人</span>
        <strong>艺人</strong>
      </button>
...
function renderCandidate(artist) {
  ...
  const signed = state.signedArtists?.some((item) => item.id === artist.id);
  const buttonText = selected ? "当前艺人" : signed ? "切换查看" : `签约 ${getSignCost(artist)}万`;
  return `
    <article class="candidate-card ${selected ? "selected" : ""}">
      ...
      <div>
        ...
        <button class="select-btn" data-select="${artist.id}">${buttonText}</button>
      </div>
    </article>
  `;
}
  ...
  return `
    <section class="panel">
      <div class="panel-header">
        ...
        <button class="advance-btn" data-advance ${!state.artist || state.pendingEvent || state.pendingMajorDecision || state.showGoalModal || state.gameOver ? "disabled" : ""}>自动推进一周</button>
      </div>
      <div class="panel-body planner">
        ${renderCompanyStrategyPanel()}
...
function renderCompanyStrategyPanel() {
  const strategy = state.companyStrategy ? getCompanyStrategy(state.companyStrategy.id) : null;
  return `
    <section class="strategy-panel ${strategy ? "active" : ""}">
      <div>
        <p class="mini-label">公司本月策略</p>
        <h3>${strategy ? strategy.name : "未制定"}</h3>
        <p>${strategy ? `${strategy.desc} 剩余 ${state.companyStrategy.weeksLeft}/4 周。` : "选择一个公司级策略，艺人会按长期定位自动执行；你只处理重大事件和异常。"}</p>
      </div>
      <div class="strategy-actions">
        <button class="primary-btn" data-open-strategy>${strategy ? "调整下月策略" : "选择本月策略"}</button>
      </div>
    </section>
  `;
}
...
function renderStrategyPickerModal() {
  return `
    <div class="modal-backdrop strategy-picker-backdrop" data-strategy-picker-close>
      <section class="goal-modal artist-manager-modal">
        <div class="goal-modal-head">
          <div>
            <p class="mini-label">公司经营会议</p>
            <h2>选择本月策略</h2>
            <p>只需要选择一次，公司旗下艺人会按长期定位自动执行。你只处理重大机会、异常和情感反馈。</p>
          </div>
          <button class="phone-close" data-strategy-picker-close title="关闭策略界面">×</button>
        </div>
        <div class="strategy-grid">
          ${companyStrategies.map(renderStrategyOption).join("")}
        </div>
      </section>
    </div>
  `;
...
function renderStrategyOption(strategy) {
  const disabled = state.money < strategy.cost || state.gameOver;
  return `
    <button class="strategy-option" data-strategy="${strategy.id}" ${disabled ? "disabled" : ""}>
      <strong>${strategy.name}</strong>
      <span>${strategy.desc}</span>
      <em>预算 ${strategy.cost} 万 / 每名艺人周回款 +${strategy.weeklyIncome} 万</em>
    </button>
  `;
}

function renderCompanyStrategyConfirmModal() {
  const strategy = getCompanyStrategy(state.pendingCompanyStrategy);
  const canAfford = state.money >= strategy.cost;
  const affected = state.signedArtists.length || 1;
  const deltaText = Object.entries(strategy.weeklyDelta || {})
    .map(([key, value]) => `${statLabels[key] || personalityLabels[key] || key}${value > 0 ? "+" : ""}${value}`)
    .join(" / ");
  return `
    <div class="modal-backdrop" data-cancel-strategy>
      <section class="goal-modal plan-confirm-modal">
        <div class="goal-modal-head">
          <div>
            <p class="mini-label">公司经营会议</p>
            <h2>${strategy.name}</h2>
        ...
        <div class="unlock-body">
          <div>
            <span>本月预算</span>
            <strong>${strategy.cost} 万</strong>
          </div>
          <div>
            <span>当前资金</span>
            <strong>${state.money} 万</strong>
          </div>
          <p>确认后公司未来 4 周按该策略自动执行，影响 ${affected} 名已签约艺人。每周策略影响：${deltaText || "无"}；每名艺人每周策略回款 +${strategy.weeklyIncome} 万。</p>
          ${canAfford ? "" : `<p class="danger-text">资金不足，还差 ${strategy.cost - state.money} 万。</p>`}
        </div>
        <div class="unlock-actions">
          <button data-cancel-strategy>取消</button>
          <button class="primary-btn" data-confirm-strategy ${canAfford ? "" : "disabled"}>确认本月策略</button>
        </div>
      </section>
    </div>
  `;
...
function renderMonthSummaryModal() {
  ...
  return `
    <div class="modal-backdrop">
      <section class="goal-modal action-modal good">
        <div class="action-modal-head">
          <p class="mini-label">月末总结 / 公司经营</p>
          <h2>${summary.title}</h2>
        </div>
        <div class="action-dialogue">
          <div class="speaker-chip">运营复盘</div>
          <p>${summary.text}</p>
          <div class="summary-list">
            ${(summary.reports || []).map((item) => `<span>${item}</span>`).join("")}
          </div>
        </div>
        <div class="action-footer">
          <span>公司资金 ${summary.money} 万</span>
          <button class="primary-btn" data-close-summary>继续</button>
        </div>
      </section>
    </div>
  `;
...
function renderArtistManagerModal() {
  const signed = state.signedArtists || [];
  const unsigned = candidateArtists.filter((artist) => !signed.some((item) => item.id === artist.id));
  return `
    <div class="modal-backdrop artist-manager-backdrop" data-artists-close>
      <section class="goal-modal artist-manager-modal">
        <div class="goal-modal-head">
          <div>
            <p class="mini-label">经纪公司艺人部</p>
            <h2>艺人</h2>
            <p>签约多个艺人，给每个人设定长期定位。日常自动执行，情感反馈和重大异常会主动找你。</p>
          </div>
          <button class="phone-close" data-artists-close title="关闭艺人界面">×</button>
        </div>
        <div class="artist-manager-body">
          <section>
            <div class="section-label">已签约艺人</div>
            <div class="roster-grid">
              ${signed.length ? signed.map(renderRosterArtist).join("") : `<p class="empty">还没有签约艺人。先从候选池里挑一个值得下注的人。</p>`}
            </div>
          </section>
          <section>
            <div class="section-label">候选池</div>
            <div class="select-grid compact">
              ${unsigned.length ? unsigned.map(renderCandidate).join("") : `<p class="empty">候选池暂时清空。公司已经把能忽悠来的都忽悠来了。</p>`}
            </div>
          </section>
        </div>
      </section>
...
function renderRosterArtist(artist) {
  const active = state.activeArtistId === artist.id;
  const position = getLongTermPosition(artist.longTermPath);
  return `
    <article class="roster-card ${active ? "active" : ""}">
      <div class="artist-head">
        <div class="portrait ${artist.color}">${artist.initial}</div>
        <div>
          <h3 class="artist-name">${artist.name}</h3>
          <p class="candidate-role">${artist.profile.marketPosition} / ${artist.role}</p>
          <div class="tag-row">${artist.tags.map((tag) => `<span class="tag">${tag}</span>`).join("")}</div>
        </div>
      </div>
      <div class="roster-metrics">
        <span>热度 <strong>${artist.market.heat}</strong></span>
        <span>粉丝 <strong>${artist.market.fans}</strong></span>
        <span>压力 <strong>${artist.mind.stress}</strong></span>
        <span>信任 <strong>${artist.mind.trust}</strong></span>
      </div>
      <div class="plan-status active">
        <strong>长期定位：${position.name}</strong>
        <span>${position.desc}</span>
      </div>
      <div class="roster-actions">
        <button data-active-artist="${artist.id}">${active ? "正在查看" : "查看状态"}</button>
      </div>
      <div class="month-plan-grid">
        ${longTermPositions.map((item) => renderPositionButton(artist, item)).join("")}
      </div>
    </article>
  `;
}

function renderPositionButton(artist, position) {
  const active = artist.longTermPath === position.id;
  return `
    <button class="month-plan-btn ${active ? "active" : ""}" data-position-artist="${artist.id}" data-position="${position.id}" ${state.gameOver ? "disabled" : ""}>
      <strong>${position.name}</strong>
      <span>${position.desc}</span>
      <em>${active ? "当前定位" : "设为长期定位"}</em>
    </button>
  `;
}

function renderPlanConfirmModal() {
  const artist = state.signedArtists.find((item) => item.id === state.pendingPlan?.artistId);
  const plan = getMonthlyPlan(state.pendingPlan?.planId);
  if (!artist || !plan) return "";
  const canAfford = state.money >= plan.cost;
  const deltaText = Object.entries(plan.weeklyDelta || {})
    .map(([key, value]) => `${statLabels[key] || personalityLabels[key] || key}${value > 0 ? "+" : ""}${value}`)
    .join(" / ");
  return `
    <div class="modal-backdrop" data-cancel-plan>
      <section class="goal-modal plan-confirm-modal">
        <div class="goal-modal-head">
          <div>
          <p class="mini-label">旧版路线规划</p>
            <h2>${artist.name}：${plan.name}</h2>
            <p>${plan.desc}</p>
          </div>
        </div>
        <div class="unlock-body">
          <div>
            <span>本轮预算</span>
            <strong>${plan.cost} 万</strong>
          </div>
          <div>
            <span>当前资金</span>
            <strong>${state.money} 万</strong>
          </div>
          <p>旧版单艺人路线确认：扣除 ${plan.cost} 万，未来 4 周自动成长：${deltaText}；每周回款 +${plan.weeklyIncome} 万。当前主循环已改为公司策略。</p>
          ${canAfford ? "" : `<p class="danger-text">资金不足，还差 ${plan.cost - state.money} 万。</p>`}
        </div>
        <div class="unlock-actions">
          <button data-cancel-plan>取消</button>
          <button class="primary-btn" data-confirm-plan ${canAfford ? "" : "disabled"}>确认规划</button>
        </div>
      </section>
    </div>
  `;
...
function renderMajorDecisionModal() {
  const decision = state.pendingMajorDecision;
  const artist = state.signedArtists.find((item) => item.id === decision.artistId);
  return `
    <div class="modal-backdrop decision-backdrop">
      <section class="goal-modal event-modal">
        <div class="goal-modal-head">
          <div>
            <p class="mini-label">${artist?.name || "艺人"} / ${pathLabels[decision.path]}</p>
        ...
        <div class="event-choice-list">
          ${decision.choices
            .map(
              (choice) => `
                <button class="event-choice" data-major-choice="${choice.id}">
                  <strong>${choice.label}</strong>
                  <span>${choice.desc}</span>
                  <em>${choice.moneyDelta ? `资金${choice.moneyDelta > 0 ? "+" : ""}${choice.moneyDelta} 万` : "路线影响"}</em>
                </button>
              `
            )
            .join("")}
...
function renderProject(project) {
  ...
  const blockedByEvent = Boolean(state.pendingEvent || state.pendingMajorDecision);
    ...
    <aside class="panel right-panel">
      <div class="panel-header">
        <div>
          ...
          <p class="panel-note">当前查看艺人 / 长期定位自动成长</p>
        </div>
      </div>
      <div class="panel-body">
...
function renderArtistSheet(artist) {
  ...
  return `
    <section class="artist-sheet">
      ...
      <div class="plan-status active">
        <strong>长期定位：${getLongTermPosition(artist.longTermPath).name}</strong>
        <span>${state.companyStrategy ? `正在响应公司策略「${state.companyStrategy.name}」，剩余 ${state.companyStrategy.weeksLeft}/4 周。` : "公司本月暂无策略，艺人按长期定位自由行动。"}</span>
      </div>
...
function bindEvents() {
  ...
  document.querySelectorAll("[data-active-artist]").forEach((button) => {
    button.addEventListener("click", () => setActiveArtist(button.dataset.activeArtist));
  });
  document.querySelectorAll("[data-position]").forEach((button) => {
    button.addEventListener("click", () => setLongTermPosition(button.dataset.positionArtist, button.dataset.position));
  });
  document.querySelectorAll("[data-plan]").forEach((button) => {
    button.addEventListener("click", () => openPlanConfirm(button.dataset.planArtist, button.dataset.plan));
  });
  document.querySelectorAll("[data-major-choice]").forEach((button) => {
    button.addEventListener("click", () => resolveMajorDecision(button.dataset.majorChoice));
  });
  ...
  document.querySelector("[data-open-artists]")?.addEventListener("click", openArtistManager);
  document.querySelector("[data-open-strategy]")?.addEventListener("click", openStrategyPicker);
  document.querySelector("[data-confirm-strategy]")?.addEventListener("click", confirmCompanyStrategy);
  document.querySelector("[data-close-summary]")?.addEventListener("click", closeMonthSummary);
  document.querySelectorAll("[data-strategy]").forEach((button) => {
    button.addEventListener("click", () => openCompanyStrategyConfirm(button.dataset.strategy));
  });
  document.querySelectorAll("[data-cancel-strategy]").forEach((element) => {
    element.addEventListener("click", (event) => {
      if (event.target === element) cancelCompanyStrategy();
    });
  });
  document.querySelectorAll("[data-strategy-picker-close]").forEach((element) => {
    element.addEventListener("click", (event) => {
      if (event.target === element) closeStrategyPicker();
    });
  });
  document.querySelector("[data-confirm-plan]")?.addEventListener("click", confirmMonthlyPlan);
  document.querySelectorAll("[data-cancel-plan]").forEach((element) => {
    element.addEventListener("click", (event) => {
      if (event.target === element) cancelMonthlyPlan();
    });
  });
  document.querySelectorAll("[data-artists-close]").forEach((element) => {
    element.addEventListener("click", (event) => {
      if (event.target === element) closeArtistManager();
    });
  });
